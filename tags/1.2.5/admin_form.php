    ...
    <form method="post">
        ...
        <table class="form-table">
            ...
            <tbody>
                ...
                <tr valing="top">
                    ...
                    <td>
                        <select name="lang" id="lang" style="width:350px;">
                            ...
                            <option value="it" <?php if(lang=="it"){ ?>selected="selected"<?php } ?>><?php echo $lang['italian']; ?></option>
                        </select>
                    </td>
                </tr>
                ...
                <tr valing="top">
                    <th scope="row">
                        <label for="lang"><?php echo $lang['position']; ?></label>
                    </th>
                    <td>
                        <select name="position" id="lang" style="width:350px;">
                            <option value="top" <?php if(position=="top"){ ?>selected="selected"<?php } ?>><?php echo $lang['top']; ?></option>
                            <option value="bottom" <?php if(position=="bottom"){ ?>selected="selected"<?php } ?>><?php echo $lang['bottom']; ?></option>
                        </select>
                    </td>
                </tr>
                ...
                <tr valing="top">
                    ...
                    <td>
                        <input type="text" class="regular-text" name="more_info_url" id="more_info_url" value="<?= $more_info_url; ?>" />
                    </td>
                </tr>
