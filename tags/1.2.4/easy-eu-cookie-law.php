    ...
    function run_cookie_law()
    {
        ...
        {            
            echo '<div class="wrap_cookies ' . position . ' font-white '.color.'">
                    <div class="message">
                        '.$lang["cookie_text"].'<a href="'.more_info_url.'" class="under" title="'.ucfirst($lang["polit_cook"]).'">'.$lang["polit_cook"].'</a>. &nbsp;&nbsp;&nbsp; <a href="#" id="cerrar_msj" title="'.$lang["accept"].'"><span class="cerrar_msj">'.strtoupper($lang["accept"]).'</span></a>
                    </div>
                </div>';
